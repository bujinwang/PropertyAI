...
const redis = config_1.config.redis.url ? new ioredis_1.Redis(config_1.config.redis.url) : new ioredis_1.Redis();
// Constants
...
exports.default = new AccountLockService();
//# sourceMappingURL=accountLockService.js.map